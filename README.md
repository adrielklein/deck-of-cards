...
A simple web app that allows users to draw from, shuffle, and reset a deck of playing cards. The app is deplyed on [Heroku](http://deck-of-cards.herokuapp.com).
